...
class IOGui(object):
    ...
    def _check_io(self):
        ...
        while True:
            ...
            sender = data[0]
            method = data[1]
            print("data in check_io", data)
            print("method %s in message.messages" % method, method in message.messages)
            if method in message.messages:
                print("getattr", getattr(self, method))
                print("args to method", (sender, data[2:]))
